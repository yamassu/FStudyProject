...
public class Logic
    ...
    public static double boxSurfaceArea(double mLength, double mWidth, double mHeight) {
        return 2.0 * (mLength * mWidth + mLength * mHeight + mWidth * mHeight);
    }
    ...
    public static double rightTrianglePerimeter(double mLength, double mWidth) {
        double hypotenuse = Math.sqrt(Math.pow(mLength, 2) + Math.pow(mWidth, 2));
        return mLength + mWidth + hypotenuse;
    }
